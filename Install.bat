cmake.exe --install ./VekAmp/build/ReleaseBuild --config Release
"C:\Qt\6.10.1\msvc2022_64\bin\windeployqt.exe" --qmldir .\VekAmp C:\PROGRA~2\VekAmp\bin\
copy .\VekAmp\Dependencies\BASS\Lib\bass.dll C:\PROGRA~2\VekAmp\bin\
copy .\VekAmp\Dependencies\BASS\Lib\bassalac.dll C:\PROGRA~2\VekAmp\bin\
